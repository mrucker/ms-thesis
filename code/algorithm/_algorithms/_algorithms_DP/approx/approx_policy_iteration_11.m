function [Pf, Vf, Xs, Ys, Ks, As, f_time, b_time, v_time, a_time] = approx_policy_iteration_11(s_1, actions, reward, value_basii, trans_post, trans_pre, gamma, N, M, T, W, l)

    assert(nargin >= 11, 'Not enough input arguments');
    ...
    g_row = [(l*gamma).^(0:T-1), zeros(1,W-1)];
