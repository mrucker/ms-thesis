function [Pf, Vf, Xs, Ys, Ks, As, f_time, b_time, v_time, a_time] = approx_policy_iteration_13f(s_1, actions, reward, value_basii, trans_post, trans_pre, gamma, N, M, T, W)
    ...
    for n = 1:N
        ...
        parfor m = 1:M
            ...
            post_values = post_values + 10*post_val_se;
