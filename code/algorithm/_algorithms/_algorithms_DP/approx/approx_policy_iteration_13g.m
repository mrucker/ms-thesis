function [Pf, Vf, Xs, Ys, Ks, As, f_time, b_time, m_time, a_time] = approx_policy_iteration_13g(s_1, actions, reward, value_basii, trans_post, trans_pre, gamma, N, M, T, W, production)
    ...
    for n = 1:N
        ...
        parfor m = 1:M
            ...
            post_val_se = 2 * ones(1, size(post_states,2));
            ...
            post_values = post_values + 1*post_val_se;
